...
public class SettingWindow extends JDialog implements ActionListener{
    ...
    private JButton confimSetting;
    private boolean type, confirm = false;
    
    public SettingWindow(JFrame frame, int timeItVal, int startItVal, int numberItVal){
        this.frame = frame;
